		...
		<script type="text/javascript" language="javascript">
				...
				$('#salvar').click(function() {
					...
					$.ajax({
						...
						success: function(response) {
							...
							$('#cadGenero input[id=id]').val('');
							$('#cadGenero input[id=nome]').val('');
							location.href='genero.php';
						}
					});
					return false;
			...
			<div id="content" class="container_16 clearfix">
				...
				<div class="window grid_4" id="editar">
					...
					<h4>Genero</h4>
					<form id="cadGenero" action="" method="POST">					
...
<tr>
	...
	<td><a href="genero.php?acao='excluir'&&idgenero=<?php echo  $id?>" onClick="return valida_exc()" class="delete">Excluir</a></td>
</tr>";?>
